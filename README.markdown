...
```bash
    ...
    curl https://raw.githubusercontent.com/chilic/spf13-vim/refs/heads/3.0/bootstrap.sh -L > spf13-vim.sh && sh spf13-vim.sh
```

If you have a bash-compatible shell you can run the script directly:
```bash

    sh <(curl https://raw.githubusercontent.com/chilic/spf13-vim/refs/heads/3.0/bootstrap.sh -L)
```
...
```bash
    ...
    curl https://raw.githubusercontent.com/chilic/spf13-vim/refs/heads/3.0/bootstrap.sh -L -o - | sh
